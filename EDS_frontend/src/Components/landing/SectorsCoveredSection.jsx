  ...
  return (
    <section className="sectors-section">
      <div className="sectors-header" data-aos="fade-up">
        <p className="sectors-tag">Sectors Covered</p>
        <h2 className="sectors-title">Every field. Every discipline.</h2>
        <p className="sectors-subtitle">
          From healthcare to engineering, AfriDATAi covers the full
          <br />
          breadth of Africa's expert landscape.
        </p>
      </div>

      <div className="sectors-grid" data-aos="fade-up" data-aos-delay="100">
